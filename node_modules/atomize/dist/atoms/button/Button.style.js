...
var computeButtonStyle = function computeButtonStyle(props, context) {
  var d = props.d,
      ...
      rest = _objectWithoutProperties(props, ["d", "pos", "top", "bottom", "left", "right", "justify", "align", "flexDir", "flexGrow", "flexWrap", "order", "m", "p", "rounded", "border", "borderColor", "h", "maxH", "minH", "w", "minW", "maxW", "cursor", "bg", "bgImg", "bgSize", "bgRepeat", "bgPos", "textSize", "textWeight", "textAlign", "textTransform", "fontFamily", "shadow", "transition", "transform", "transformOrigin", "zIndex", "overflow", "opacity", "hoverBg", "hoverTextColor", "hoverBorderColor", "hoverShadow", "focusBorderColor", "isOpen", "hover", "offset", "size", "targetHover", "disableColor", "disableBorderColor", "disableShadow", "disableBg"]);
