...
var computeTextStyle = function computeTextStyle(props, context) {
  var d = props.d,
      ...
      rest = _objectWithoutProperties(props, ["d", "pos", "top", "bottom", "left", "right", "h", "maxH", "minH", "justify", "align", "flexDir", "flexGrow", "flexWrap", "order", "rounded", "border", "borderColor", "m", "p", "bg", "textColor", "textWeight", "textAlign", "textTransform", "textDecor", "textSize", "transition", "w", "maxW", "minW", "fontFamily", "opacity", "hoverBg", "hoverBorderColor", "hoverTextColor", "tag", "theme", "cursor", "transform", "transformOrigin", "shadow", "zIndex", "overflow", "hoverShadow"]);
