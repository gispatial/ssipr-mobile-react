...
<html lang="en">
<head>
    <title>Code coverage report for components/Radio/Radio.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">components/Radio</a> Radio.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
    if (type === 'cell') {
      return (
        &lt;Cell disabled={disabled} description={checked ? <span class="branch-0 cbranch-no" title="branch not covered" >&lt;Icon type="right" theme={disabled ? null : theme} /&gt; </span>: null} onClick={<span class="fstat-no" title="function not covered" >()</span> =&gt; {}}&gt;
