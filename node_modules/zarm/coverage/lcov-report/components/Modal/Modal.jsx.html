...
<html lang="en">
<head>
    <title>Code coverage report for components/Modal/Modal.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">components/Modal</a> Modal.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  componentWillReceiveProps(nextProps) {
    if (!this.props.visible &amp;&amp; nextProps.visible) {
      this.enter();
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (this.props.visible &amp;&amp; !nextProps.visible) {
      this.leave();
    }
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    if (this.state.animationState === 'leave') {</span>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Mon Oct 30 2017 15:56:47 GMT+0800 (CST)
</div>
</div>
