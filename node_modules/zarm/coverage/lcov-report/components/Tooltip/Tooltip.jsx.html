...
<html lang="en">
<head>
    <title>Code coverage report for components/Tooltip/Tooltip.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">components/Tooltip</a> Tooltip.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  componentDidMount() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!window.zarmTooltip) {
