...
<html lang="en">
<head>
    <title>Code coverage report for components/Message/index.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">components/Message</a> index.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  static defaultProps = {
    prefixCl<span class="missing-if-branch" title="else path not taken" >E</span>s: 'za-message',
    theme: 'primary',
    hasArrow: false,
    hasClosable: false,
  };
