...
<html lang="en">
<head>
    <title>Code coverage report for components/Tab/Tab.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">components/Tab</a> Tab.jsx
    </h1>
    <div class='clearfix'>
...
function getSelectIndex(children) {
  ...
  React.Children.forEach(children, (item, $index) =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (item.props &amp;&amp; item.props.selected) {
<span class="cstat-no" title="statement not covered" >      selectIndex = $index;</span>
    }
  });
  return selectIndex;
}
...
&nbsp;
  componentWillReceiveProps(nextProps) {
    if ('value' in nextProps || getSelectIndex(nextProps.children)) {
      this.setState({
        value: nextProps.value || <span class="branch-1 cbranch-no" title="branch not covered" >nextProps.defaultValue </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >getSelectIndex(nextProps.children) </span>|| <span class="branch-3 cbranch-no" title="branch not covered" >0,</span>
      });
    ...
    if (canSwipe) {
      contentRender = (
        &lt;Swipe
          ...
          onChange={<span class="fstat-no" title="function not covered" >(v</span>alue) =&gt; {
