...
<html lang="en">
<head>
    <title>Code coverage report for NoticeBar/NoticeBar.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">NoticeBar</a> NoticeBar.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (distance &gt; 0) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
    let delay = 1000;
