...
<html lang="en">
<head>
    <title>Code coverage report for Checkbox/CheckboxGroup.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">Checkbox</a> CheckboxGroup.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  componentWillReceiveProps(nextProps) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if ('value' in nextProps || <span class="branch-1 cbranch-no" title="branch not covered" >getChildChecked(nextProps.children).length &gt; 0)</span> {
      this.setState({
