...
<html lang="en">
<head>
    <title>Code coverage report for Stepper/Stepper.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">Stepper</a> Stepper.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  onInputBlur = (value) =&gt; {
    ...
    value = Number(value);
    <span class="missing-if-branch" title="if path not taken" >I</span>if (value === '' || isNaN(value)) {
<span class="cstat-no" title="statement not covered" >      value = this.state.lastValue;</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (min !== null &amp;&amp; value &lt; min) {
<span class="cstat-no" title="statement not covered" >      value = min;</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (max !== null &amp;&amp; value &gt; max) {
...
&nbsp;
    const subDisabled = !!(typeof min === 'number' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >value &lt;= min)</span> || disabled;
    const plusDisabled = !!(typeof max === 'number' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >value &gt;= max)</span> || disabled;
&nbsp;
