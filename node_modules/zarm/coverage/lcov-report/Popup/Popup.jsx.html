...
<html lang="en">
<head>
    <title>Code coverage report for Popup/Popup.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">Popup</a> Popup.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  animationEnd = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
    const { onClose } = <span class="cstat-no" title="statement not covered" >this.props;</span>
    const { animationState } = <span class="cstat-no" title="statement not covered" >this.state;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (animationState === 'leave') {</span>
