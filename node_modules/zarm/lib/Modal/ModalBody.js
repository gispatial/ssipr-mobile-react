  ...
  _createClass(ModalBody, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          others = _objectWithoutProperties(_props, ['prefixCls', 'className', 'height', 'children']);

      var cls = (0, _classnames2.default)(prefixCls + '-body', className);
      ...
      return _react2.default.createElement(
        'div',
        _extends({ className: cls, style: bodyStyle }, others),
        children
      );
    }
  }]);
