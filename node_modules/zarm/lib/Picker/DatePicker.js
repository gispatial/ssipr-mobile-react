...
var DatePicker = function (_Component) {
  ...
  _createClass(DatePicker, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames4.default)((_classnames = {}, _defineProperty(_classnames, prefixCls + '-container', true), _defineProperty(_classnames, prefixCls + '-hidden', !this.state.visible), _defineProperty(_classnames, className, !!className), _classnames));

      var inputCls = (0, _classnames4.default)((_classnames2 = {}, _defineProperty(_classnames2, prefixCls + '-input', true), _defineProperty(_classnames2, prefixCls + '-placeholder', !this.state.date), _defineProperty(_classnames2, prefixCls + '-disabled', !!disabled), _classnames2));
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: inputCls },
          _react2.default.createElement('input', { type: 'hidden', value: this.state.date }),
