...
var Column = function (_Component) {
  ...
  function Column(props) {
    ...
    if (selectedValue !== undefined) {
      ...
      selectedValueState = children[0][_this.props.valueMember];
    }
    _this.state = {
  ...
  _createClass(Column, [{
    ...
    value: function componentDidMount() {
      ...
      this.zscroller = new _zscroller2.default(this.content, {
        scrollingX: false,
        snapping: true,
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      return this.state.selectedValue !== nextState.selectedValue || !(0, _utils.isChildrenEqual)(this.props.children, nextProps.children, this.props.pure);
    }
  }, {
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          displayMember = _props.displayMember,
          indicatorStyle = _props.indicatorStyle,
          valueMember = _props.valueMember;
      var selectedValue = this.state.selectedValue;

      var itemClassName = prefixCls + '-cascader-item';
      var selectedItemClassName = itemClassName + ' ' + prefixCls + '-cascader-item-selected';
      ...
      var pickerCls = (_pickerCls = {}, _defineProperty(_pickerCls, className, !!className), _defineProperty(_pickerCls, prefixCls + '-cascader', true), _pickerCls);
      return _react2.default.createElement(
        'div',
        {
          className: (0, _classnames2.default)(pickerCls) },
        _react2.default.createElement('div', { className: prefixCls + '-cascader-indicator', ref: function ref(indicator) {
            _this2.indicator = indicator;
          }, style: indicatorStyle }),
        _react2.default.createElement(
          'div',
          { className: prefixCls + '-cascader-content', ref: function ref(content) {
