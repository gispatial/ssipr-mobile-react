  ...
  render() {
    ...
    return (
      <Container>
        <Content padder>
          <Header
            title="SSIPR Selangor"
            content="IPR Smart Selangor menyelaraskan program Skim Air Darul Ehsan sebagai program penjajaran semula pemberian air percuma kepada kumpulan sasar penduduk Negeri Selangor."
          />
